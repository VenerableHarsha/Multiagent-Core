...
from core.prompt.browser import NEXT_STEP_PROMPT, SYSTEM_PROMPT
from core.schema import Message, ToolChoice
from core.tool import BrowserUseTool, Terminate, ToolCollection


# Avoid circular import if BrowserAgent needs BrowserContextHelper
if TYPE_CHECKING:
    from core.agent.base import BaseAgent  # Or wherever memory is defined
